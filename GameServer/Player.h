...
public:
	...
	bool CheckZhuiFengGang(std::map<int32_t/*麻将牌类型*/, std::vector<int32_t>/*牌值*/>& cards); //检查追风杠
	...
	const std::vector<Asset::PaiElement>& CalculateJueTouHui(const Asset::PaiElement& pai); //获取绝头会儿的数量
